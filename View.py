...
class View():
    ...
    #confirmação da função alterar
    def alterar(self, idSensor):
        self.lblmsg["text"] = "O sensor {} foi atualizado com sucesso!".format(idSensor);

    #confirmação da função excluir 
    def excluir(self,idSensor):
        self.lblmsg["text"] = "O sensor {} foi excluído com sucesso!".format(idSensor);

    #confirmação da função atualizar 
    def commit(self):
        self.lblmsg["text"] = "O Banco de dados foi atualizado com sucesso!";